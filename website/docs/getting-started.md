...
:::note
Botrino v1.0.0-alpha1 also adds `java.sql`, this is an oversight so you can remove it safely if you don't use SQL features. It will be removed by default in next release.
:::
