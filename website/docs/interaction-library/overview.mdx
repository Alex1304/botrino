...
1. Initialize your project by following the steps in the [Getting Started page](../getting-started.mdx).

   :::tip
   If you decide to use the Maven archetype, the library will be already added, so you won't need to follow the next
   steps! Otherwise, continue reading.
   :::
