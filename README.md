...
It also aims at providing a [command extension](https://botrino.alex1304.com/command-extension/overview) that integrates well with the structure of Botrino, while still letting you the choice of using your own.
